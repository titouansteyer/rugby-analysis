...
def init_db():
    ...
    cursor.executescript("""
        ...
        CREATE TABLE IF NOT EXISTS player_match_stats (
            ...
            badPasses REAL, ballOutOfPlay REAL, catchFromKick REAL,
            collectionFailed REAL, collectionFromKick REAL, collectionInterception REAL,
            collectionLooseBall REAL, collectionSuccess REAL, droppedCatch REAL,
            handlingError REAL, pickup REAL,
            passes REAL, runs REAL, metres REAL, attackingKicks REAL,
            offload REAL, cleanBreaks REAL, defendersBeaten REAL, breakAssist REAL,
            ...
            points REAL, tries REAL, tryAssists REAL, tryBonusPoints REAL,
            conversionGoals REAL, missedConversionGoals REAL,
            dropGoalsConverted REAL, dropGoalMissed REAL,
            penaltyGoals REAL, missedPenaltyGoals REAL,
            goals REAL, missedGoals REAL, goalsFromMark REAL, losingBonusPoints REAL,
            penaltiesConceded REAL, redCards REAL, yellowCards REAL, onReport REAL,
            penaltyConcededCollapsingMaul REAL, penaltyConcededCollapsingOffense REAL,
            penaltyConcededDelibKnockOn REAL, penaltyConcededDissent REAL,
            penaltyConcededEarlyTackle REAL, penaltyConcededFoulPlay REAL,
            penaltyConcededHandlingInRuck REAL, penaltyConcededHighTackle REAL,
            penaltyConcededKillingRuck REAL, penaltyConcededLineoutOffence REAL,
            penaltyConcededObstruction REAL, penaltyConcededOffside REAL,
            penaltyConcededOppHalf REAL, penaltyConcededOther REAL,
            penaltyConcededOwnHalf REAL, penaltyConcededScrumOffence REAL,
            penaltyConcededStamping REAL, penaltyConcededWrongSide REAL,
            kicks REAL, kickMetres REAL, kicksFromHand REAL, kickFromHandMetres REAL,
            kickReturns REAL, kickReturnMetres REAL,
            kickInField REAL, kickInTouch REAL, kickOutOfPlay REAL,
            kickTouchInGoal REAL, kickTryScored REAL, kickChargedDown REAL,
            kickOppnCollection REAL, kickPossessionLost REAL, kickPossessionRetained REAL,
            kickPercentSuccess REAL, pcKickPercent REAL,
            kickPenaltyGood REAL, kickPenaltyBad REAL,
            retainedKicks REAL, trueRetainedKicks REAL, tryKicks REAL,
            penaltyKickForTouchMetres REAL, fortyTwenty REAL,
            turnoverWon REAL, turnoversConceded REAL, turnoverOppHalf REAL,
            turnoverOwnHalf REAL, turnoverLostInRuckOrMaul REAL, turnoverKnockOn REAL,
            turnoverForwardPass REAL, turnoverCarriedInTouch REAL, turnoverCarriedOver REAL,
            turnoverKickError REAL, turnoverBadPass REAL,
            lineoutsWon REAL, lineoutsLost REAL, lineoutSuccess REAL, totalLineouts REAL,
            lineoutNonStraight REAL, lineoutsInfringeOpp REAL, lineoutsToOwnPlayer REAL,
            lineoutWonOppThrow REAL, lineoutWonOwnThrow REAL, lineoutWonSteal REAL,
            lineoutThrowLostFreeKick REAL, lineoutThrowLostHandlingError REAL,
            lineoutThrowLostNotStraight REAL, lineoutThrowLostOutright REAL,
            lineoutThrowLostPenalty REAL, lineoutThrowWonClean REAL,
            lineoutThrowWonFreeKick REAL, lineoutThrowWonPenalty REAL, lineoutThrowWonTap REAL,
            scrumsLostFreeKick REAL, scrumsLostOutright REAL, scrumsLostPenalty REAL,
            scrumsLostReversed REAL, scrumsWonFreeKick REAL, scrumsWonOutright REAL,
            scrumsWonPenalty REAL, scrumsWonPenaltyTry REAL, scrumsWonPushoverTry REAL,
            maulsWon REAL, maulsWonOutright REAL, maulsWonPenalty REAL,
            maulsWonPenaltyTry REAL, maulsWonTry REAL,
            maulsLost REAL, maulsLostOutright REAL, maulsLostTurnover REAL,
            rucksWon REAL, rucksLost REAL,
            restart22m REAL, restartHalfway REAL, restartOwnPlayer REAL, restartOppPlayer REAL,
            restartOppError REAL, restartErrorNotTen REAL, restartErrorOutOfPlay REAL,
            restartsWon REAL, restartsLost REAL, restartsSuccess REAL,
            freeKickConcededAtLineout REAL, freeKickConcededAtScrum REAL,
            freeKickConcededInGeneralPlay REAL, freeKickConcededInRuckOrMaul REAL,
            totalFreeKicksConceded REAL,
            minutesPlayedTotal REAL,
            minutesPlayedFirstHalf REAL, minutesPlayedSecondHalf REAL,
            minutesPlayedFirstHalfExtra REAL, minutesPlayedSecondHalfExtra REAL,
            minutesPlayedBeforeFirstHalf REAL, minutesPlayedBeforeSecondHalf REAL,
            mintuesPlayedBeforeFirstHalfExtra REAL, minutesPlayedBeforeSecondHalfExtra REAL,
            minutesPlayedBeforePenaltyShootOut REAL,
            won REAL, lost REAL, drawn REAL, numberOfTeams REAL, matches REAL,
            startingMatches REAL, replacementMatches REAL,
